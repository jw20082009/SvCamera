...
public class GLImageGaussPassFilter extends GLImageFilter {
    ...
    public GLImageGaussPassFilter(Context context) {
        this(context, OpenGLUtils.getShaderFromAssets(context, "shader/vertex_gaussian_pass.glsl"),
                OpenGLUtils.getShaderFromAssets(context, "shader/fragment_gaussian_pass.glsl"));
    }
